        ...
        return (
            <div className="card-body">
                ...
                <div className="d-inline-block">
                    <Link to={`/`} className="btn btn-raised btn-primary btn-sm mr-5 mx-2">
                        Back to posts
                    </Link>

                    {isAuthenticated().user && isAuthenticated().user._id === post.postedBy._id && (
                        <>
                            <Link to={`/post/edit/${post._id}`} className="btn btn-raised btn-warning btn-sm mr-5 mx-2">
                                Update Post
                            </Link>
...
//                 {like ? (<h3 onClick={this.likeToggle}>
//                     <i className="fa fa-thumbs-up text-success bg-dark" style={{padding: "10px", borderRadius: '50%'}}/>{" "}{likes} Like</h3>) : (
//                     <h3 onClick={this.likeToggle}>
//                     <i className="fa fa-thumbs-up text-warning bg-dark" style={{padding: "10px", borderRadius: '50%'}}/>{" "}{likes} Like</h3>
//                 )}
